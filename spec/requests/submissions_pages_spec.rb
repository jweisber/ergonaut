  ...
  context "when signed in as a managing editor" do
    ...
    describe "show page" do
      ...
      context "when there are pending and declined referee assignments" do
        ...
        it "has a link to edit the due date of the pending assignment" do
          expect(page).to have_link(@pending_assignment.report_due_at.strftime("%b. %-d, %Y"),
                                    href: edit_due_date_submission_referee_assignment_path(@submission, @pending_assignment))
        end
