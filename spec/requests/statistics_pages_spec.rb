...
describe "Statistics pages" do
  ...
  describe "show page for current year" do
    before do
      ...
      2.times { create(:desk_rejected_submission).update_attributes(decision_entered_at: 5.days.from_now) }
      2.times { create(:rejected_after_review_submission).update_attributes(decision_entered_at: 10.days.from_now) }
      2.times do
      ...
      2.times { create(:accepted_submission).update_attributes(decision_entered_at: 35.days.from_now) }
    ...
    it "loads the statistics for submissions by area" do
      ...
      expect(chart_scripts[3][0]).to match(/"Ar\. \d* ":1/)
    end
  end
  ...
  describe "show page for 2014" do
    ...
    it "shows the statistics for 2014", js: true do
      ...
      expect(page).to have_content("22.2%")
      expect(page).to have_content("77.8%")
    end
